...
[x] Router  
[ ] coder ! + tests  
[ ] Refaire CSS  à ma sauce  (faire des variables pour les couleurs)  
[ ] Faire responsive  
...
- **ChallengeResult.vue** : affichage du random challenge  

### COMPONENTS
- **ChallengeChoices.vue** : définit les packs, options et restriction pour générer le challenge via le btn  
